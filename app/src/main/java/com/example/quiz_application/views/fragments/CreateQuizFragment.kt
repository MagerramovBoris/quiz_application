package com.example.quiz_application.views.fragments
...
import com.example.quiz_application.databinding.FragmentCreateQuizBinding
import com.example.quiz_application.viewmodel.QuizListViewModel
...
class CreateQuizFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentCreateQuizBinding.imagePlaceholder.setOnClickListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == GALLERY_CODE) {
            if (data != null) {
                ...
                fragmentCreateQuizBinding.imagePlaceholder.visibility = View.GONE
            } else
                fragmentCreateQuizBinding.imagePlaceholder.visibility = View.VISIBLE
        }
    }
